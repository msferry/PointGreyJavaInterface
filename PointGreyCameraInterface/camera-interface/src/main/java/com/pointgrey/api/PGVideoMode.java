...
public enum PGVideoMode { //23 video modes...{        
	...
	VIDEOMODE_640x480Y8(640, 480, 8), /**< 640x480 8-bit. */
	VIDEOMODE_640x480Y16(640, 480, 16), /**< 640x480 16-bit. */
	...
	VIDEOMODE_1280x960Y8(1280, 960, 8), /**< 1280x960 8-bit. */
	VIDEOMODE_1280x960Y16(1280, 960, 16), /**< 1280x960 16-bit. */
